...
local aa = {
    ...
    [47] = function()
        ...
        local af = {Names = {"dusty.ontop", "Darker", "Light", "Aqua", "Amethyst", "Rose"}}
    ...
    [50] = function()
        ...
        return {
            Name = "dusty.ontop",
            Accent = Color3.fromRGB(178, 107, 159),
            AcrylicMain = Color3.fromRGB(1, 1, 1),
            AcrylicBorder = Color3.fromRGB(60, 60, 60),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(1, 1, 1), Color3.fromRGB(1, 1, 1)),
            AcrylicNoise = 0.9,
            TitleBarLine = Color3.fromRGB(1, 1, 1), --title bar line
            Tab = Color3.fromRGB(50, 50, 50),
            Element = Color3.fromRGB(1, 1, 1),
            ElementBorder = Color3.fromRGB(50, 50, 50),
            InElementBorder = Color3.fromRGB(1, 1, 1),
